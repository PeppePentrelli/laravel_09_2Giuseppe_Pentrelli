...
<div class="container">
    <div class="row ">
      ...
      <div class="col-3 my-5 justify-content-center align-items-center d-flex flex-column div-skin-wrapper"> <a href="{{route('paginaDettaglioSkin',  ['id' => $skin['id']])}}">
...
<div class="wave">
    <svg viewBox="0 0 1440 150" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" style="transform: scaleY(-1);">

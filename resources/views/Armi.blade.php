...
<section class="container my-4 ">
    <div class="row g-4">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card arma-card text-white shadow" style="background-image: url({{ $arma['img-bg-card'] }});" data-aos="fade-up">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('paginaDettaglioArmi', ['id' => $arma['id']]) }}" class="btn btn-fortnite">

<x-layout>
    ...
    <section id="carousel-chi-siamo" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <!-- Slide 1: Chi siamo -->
            <div
                class="carousel-item active vh-100 d-flex align-items-center justify-content-center position-relative chiSiamoCarousel1">
            ...
            <div
                class="carousel-item vh-100 d-flex align-items-center justify-content-center position-relative chiSiamoCarousel2">
                <div class="overlay"></div>
            ...
            <div
                class="carousel-item vh-100 position-relative overflow-hidden chiSiamoCarousel3 d-flex align-items-center justify-content-center">


                <div class="text-center text-white position-relative z-1 text-glass px-3" data-aos="fade-up"
                    data-aos-delay="300">
    ...
    <section id="chiSono" class="py-5 sezione-personale">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="sottotitolo-sezione">Un progetto portato avanti da una persona con passione, visione e
                    competenze trasversali.</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="card personal-card shadow-lg border-0">
                        <div class="card-body text-center p-5">
                            <img src="/Media/peppe.png" alt="Giuseppe Pentrelli"
                                class="rounded-circle mb-4 personal-img shadow img-fluid">
                            ...
                            <p class="descrizione-autore">
                                Gestisco l’intero progetto: dal design allo sviluppo, fino alla gestione della
                                community.
                                Amo trasformare idee in realtà digitali, con attenzione a ogni dettaglio tecnico e
                                visivo.
                            </p>
                            ...
                            <ul class="list-unstyled text-center competenze-lista">
                                ...
                                <li><i class="bi bi-lightbulb me-2"></i>Creatività, strategia e visione a lungo termine
                                </li>
                            </ul>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up">
                    <div class="p-4 border rounded bg-white shadow-sm h-100">
                        ...
                        <p class="fs-4">Accogliamo ogni giocatore, indipendentemente da età, provenienza o livello di
                            esperienza.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="p-4 border rounded bg-white shadow-sm h-100">
                        ...
                        <p class="fs-4">Crediamo nella forza del lavoro di squadra e nel supporto reciproco per
                            crescere insieme.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="p-4 border rounded bg-white shadow-sm h-100">
                        ...
                        <p class="fs-4">Supportiamo la crescita personale e tecnica dei membri attraverso eventi e
    ...
    <section id="missione" class="py-5 bg-dark text-white">
        <div class="container text-center">
            ...
            <p class="lead mb-4 fs-3">Vogliamo creare un luogo dove i giocatori possano sentirsi accolti, ascoltati e
                ispirati. La nostra missione è quella di costruire una comunità forte, inclusiva e rispettosa, dove ogni
                membro possa esprimere la propria passione per il gioco in un ambiente positivo e stimolante.</p>
            <p class="mb-4 fs-4">Ci impegniamo a offrire esperienze uniche, creando opportunità di crescita,
                divertimento e apprendimento. Crediamo nel potere della collaborazione e nel fatto che ogni singolo
                giocatore, con la sua unicità, contribuisce a rendere la nostra community un posto migliore.</p>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card bg-light text-dark">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-5">Accogliamo giocatori di ogni livello, background e provenienza.
                                Il nostro obiettivo è creare un ambiente dove tutti si sentano liberi di esprimere la
                                propria passione per il gaming.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card bg-light text-dark">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-5">Siamo convinti che il gioco sia più divertente quando si lavora
                                insieme. La nostra missione è facilitare la creazione di squadre, l'apprendimento
                                reciproco e la condivisione delle esperienze di gioco.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card bg-light text-dark">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-5">Siamo qui per divertirci! La nostra missione è garantire che ogni
                                giocatore possa divertirsi, imparare e crescere attraverso il gioco, in un ambiente sano
                                e stimolante.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-5">
                ...
                <p class="lead">Se anche tu credi che il gioco sia un'opportunità per crescere e divertirsi insieme,
                    non aspettare oltre! Entra a far parte della nostra community e inizia a vivere la tua avventura!
                </p>
        ...
        <section class=" d-flex align-items-center justify-content-center text-center text-white">
            <div class="div-remember">
                ...
                @if (session('message'))
                    <div class="alert alert-success bg-dark text-white text-center mt-3"
                        style="font-size: clamp(16px, 7vw, 40px);">
                ...
                <form id="iscrizione" class=" mx-auto" style="" method="POST"
                    ...
                    <div class="mb-3">
                        <textarea name="description" class="form-control my-input text-white" rows="4"

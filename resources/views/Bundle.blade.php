        ...
        <div class="row align-items-center flex-column flex-md-row mt-4">
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-end mx-0">
                <div class="img-wrapper-bundle1">
                    <img style="{{$bundle['cheat']}}" class="img-bundle1 justify-content-start d-flex" src="/Media/{{$bundle['img-bundle1']}}" alt="Personaggio">
                </div>
            </div>
        </div>
...
<section class="section-remember-sign-in d-flex align-items-center justify-content-center text-center text-white py-5 px-3">
  <div class="div-remember w-100" style="max-width: 600px;">
    ...
    <form id="iscrizione" method="POST" action="{{ route('send_email') }}">
        ...
        <div class="text-center mt-4">
            <img src="/Media/battle-bus.png" alt="Immagine bus della battaglia" class="img-fluid" style="max-width: 200px;">
        </div>
    </form>
  </div>
</section>

        ...
        <div class="row  d-flex justify-content-center align-items-center">
            ...
            <div class="container my-5">
                ...
                <div class="row justify-content-center align-items-center my-4">
                    <div class="col-md-6">
                        <div class="glass-box-contest-header p-4 text-center"
                            style="max-width: 340px; word-wrap: break-word; margin-top:300px;">
                            <h4>Step 1</h4>
                            <p class="fs-1">Partecipa al contest, compila il form e carica la tua immagine preferita.
                            </p>
                            <hr>
                ...
                <div class="row justify-content-center align-items-center my-4 ">
                    <div class="col-md-6 offset-md-6">
                        <div class="glass-box-contest-header p-4 text-center"
                            style="max-width: 340px; word-wrap: break-word;">
                            <h4>Step 2</h4>
            ...
            <div class="col-12 d-flex justify-content-center align-items-center glass-box-contest-header px-5 mb-5">
                <form id="contestForm" class="contest-form" action="{{ route('contest.store') }}#contestForm"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    @csrf
                    <div>
                        <label class="fs-3" for="nomeGiocatore">Nome Giocatore</label>
                        <input class=" form-control" type="text" id="nomeGiocatore" name="nome_giocatore"
                            value="{{ old('nome_giocatore') }}">
                    </div>
